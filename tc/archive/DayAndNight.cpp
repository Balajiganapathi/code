...
namespace moj_harness {
	...
	int run_test_case(int casenum__) {
		...
		case 0: {
			...
			int received__            = DayAndNight().minimalCost(vector <int>(a, a + (sizeof a / sizeof a[0])), vector <int>(b, b + (sizeof b / sizeof b[0])), vector <int>(day, day + (sizeof day / sizeof day[0])), vector <int>(night, night + (sizeof night / sizeof night[0])), dayToNight, nightToDay);
