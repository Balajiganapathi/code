    ...
    bool ok(int i, int j) {
        ...
        fo(iter, n * m + 2) {
            ...
            if(cr[ci][cj] == '|') {
                ...
                if(is_top(cr[ci][cj], cf[ci][cj]) && di == 1) {
                    h = true;
                } else if(is_bottom(cr[ci][cj], cf[ci][cj]) && di == -1) {
                    h = true;
                } else if(is_left(cr[ci][cj], cf[ci][cj]) && dj == 1) {
                    v = true;
                } else if(is_right(cr[ci][cj], cf[ci][cj]) && dj == -1) {
                    v = true;
                } else {
                    return false;
                }
                if(h) {
                    if(is_left(cr[ci][cj], cf[ci][cj])) di = 0, dj = -1;
                    else if(is_right(cr[ci][cj], cf[ci][cj])) di = 0, dj = 1;
                    else return false;
                } else if(v) {
                    if(is_top(cr[ci][cj], cf[ci][cj])) di = -1, dj = 0;
                    else if(is_bottom(cr[ci][cj], cf[ci][cj])) di = 1, dj = 0;
                    else return false;
                } else {
                    return false;
                }
